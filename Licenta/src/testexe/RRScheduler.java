...
public class RRScheduler {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream input = RRScheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            RRDatacenterBroker broker = createBroker("Broker_0");
            ...
            System.out.println(RRScheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static RRDatacenterBroker createBroker(String name) throws Exception {
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = RRScheduler.class.getResourceAsStream(filename);
