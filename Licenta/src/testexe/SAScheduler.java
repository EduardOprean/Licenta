...
public class SAScheduler {
    ...
    public static void main(String[] args) {
        System.out.println("Starting SA Scheduler...");

        Properties properties = new Properties();
        try (InputStream input = SAScheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            SADatacenterBroker broker = createBroker("Broker_0");
            ...
            System.out.println(SAScheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static SADatacenterBroker createBroker(String name) throws Exception {
        return new SADatacenterBroker(name);
    }
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = SAScheduler.class.getResourceAsStream(filename);
