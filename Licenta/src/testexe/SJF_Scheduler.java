...
public class SJF_Scheduler {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream input = SJF_Scheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            System.out.println(SJF_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = SJF_Scheduler.class.getResourceAsStream(filename);
