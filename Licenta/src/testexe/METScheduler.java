...
public class METScheduler {
    ...
    public static void main(String[] args) {
        System.out.println("Starting MET Scheduler...");

        Properties properties = new Properties();
        try (InputStream input = METScheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            MetDatacenterBroker broker = createBroker("Broker_0");
            ...
            System.out.println(METScheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static MetDatacenterBroker createBroker(String name) throws Exception {
        return new MetDatacenterBroker(name);
    }
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = METScheduler.class.getResourceAsStream(filename);
