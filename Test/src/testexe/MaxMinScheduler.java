...
public class MaxMinScheduler {
    ...
    public static void main(String[] args) {
        System.out.println("Starting MaxMin Scheduler...");

        Properties properties = new Properties();
        try (InputStream input = MaxMinScheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            MaxMinDatacenterBroker broker = createBroker("Broker_0");
            ...
            System.out.println(MaxMinScheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static MaxMinDatacenterBroker createBroker(String name) throws Exception {
        return new MaxMinDatacenterBroker(name);
    }
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = MaxMinScheduler.class.getResourceAsStream(filename);
