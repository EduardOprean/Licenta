...
public class FCFS_Scheduler {
    ...
    public static void main(String[] args) {
        System.out.println("Starting FCFS Scheduler...");

        Properties properties = new Properties();
        try (InputStream input = FCFS_Scheduler.class.getResourceAsStream("/config.properties")) {
            if (input == null) {
        ...
        try {
            ...
            System.out.println(FCFS_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static List<Cloudlet> readCloudletsFromFile(String filename, int userId) {
        ...
        try (InputStream inputStream = FCFS_Scheduler.class.getResourceAsStream(filename);
